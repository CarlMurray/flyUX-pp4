...
const clickHandler = function (e) {
  ...
  //  ELSE IF SELECTED FLIGHT NOT ALREADY EXPANDED:
    ...
    if (alreadySelected) {
      ...
      let faresWrapperSelected = alreadySelected.querySelector(
        ".flight-fares-wrapper"
      );
...
const toggleFlightFares = function () {
  let flightCardContainers = document.querySelectorAll(".flight-details-card");
...
const reattachOutboundListeners = function () {
  ...
  outboundAltDates = document.querySelectorAll(
...
const addSelectedFlight = function (selected) {
  ...
  if (tripType === "return") {
    ...
    if (
      document.querySelector("#outbound-selected") &&
      document.querySelector("#return-selected")
    ) {
